...
def account():
    ...
    return render_template('account.html', title='Account', current_user=current_user, image_file=image_file, form=form)

@app.route("/post/new")
@login_required
def new_post():
    return render_template('create_post.hmtl', title='New Post')